...
public jadwal() {
    ...
    try {
        ...
        String jurusanTerpilih = (cbjurusan.getSelectedItem() != null)
                ? cbjurusan.getSelectedItem().toString() : "";

        ResultSet rs = st.executeQuery(
            "SELECT DISTINCT kelas FROM jadwal WHERE jurusan='" + jurusanTerpilih + "'");
...
private void tampilTabel() {
    ...
    try {
        ...
        System.out.println("Jurusan dipilih: [" + cbjurusan.getSelectedItem() + "]");
System.out.println("Kelas dipilih: [" + cbkelas.getSelectedItem() + "]");
...
System.out.println("Jumlah baris ditemukan: " + jumlahRow);
...
tbljadwal.setModel(model);
    ...
    private void btnJadwalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJadwalActionPerformed
         javax.swing.JFrame frame = new javax.swing.JFrame("Tambah Jadwal");
         frame.setDefaultCloseOperation(javax.swing.JFrame.DISPOSE_ON_CLOSE);
         frame.setContentPane(new inputjadwal());
         frame.pack();
